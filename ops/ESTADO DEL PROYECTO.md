...
`2026-08-02` — Creados 7 agentes opencode (director, ventas, soporte, finanzas, webdev, contenido, didactica). Plan estratégico docs/ESTRATEGIA COMERCIAL - ACN INSTITUTE ONLINE.md listo.
...
6. [ ] Imprimir folletos y tarjetas
7. [ ] Implementar Wompi como pasarela de pago

## 🛠️ Stack tecnológico
| Herramienta | Estado | Notas |
|------------|--------|-------|
| Web (Next.js) | Casi lista | Falta: número WhatsApp real, pasarela pago |
